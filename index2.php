...
>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="">
      <img
        src="https://source.unsplash.com/U0dBV_QeiYk"
        class="d-block w-100"
        height="600"
        alt="..."
      />
      <div class="carousel-caption d-none d-md-block">
        ...
        <button type="button" class="btn btn-danger mx-2">
          Engineering #<?php echo $row['engineering_rank'] ?></button
        ><button type="button" class="btn btn-warning mx-2">
          Business #<?php echo $row['business_rank'] ?></button
        ><button type="button" class="btn btn-info mx-2">
          College #<?php echo $row['college_rank'] ?>
        </button>
      </div>
    </div>
    <div class="carousel-item" data-bs-interval="">
      <img
        src="https://source.unsplash.com/_kd5cxwZOK4"
        class="d-block w-100"
        height="600"
        alt="..."
      />
    ...
    <div class="carousel-item" data-bs-interval="">
      <img
        src="https://source.unsplash.com/ggeZ9oyI-PE"
        class="d-block w-100"
        height="600"
        alt="..."
      />
...
<div class="container my-4">
  <div class="row">
    ...
    <div class="col-lg-4 panel">
      ...
      <p><?php echo substr($row['speech'],0,100) ?>...</p>
  ...
  <div class="row featurette">
    <div class="col-md-7">
      ...
      <?php
          ...
          $row = mysqli_fetch_array($result);
        ?>
      <p class="lead"><?php echo substr($row['info'],0,800) ?></p>
    </div>
    <div class="col-md-5 my-4 pt-4">
      <div class="col-xs-12">
        <div class="hovereffect">
          <img class="img-responsive" src="<?php echo $row['photo'] ?>" width="500" height="300" role="img" alt="About Image">
          <div class="overlay">
